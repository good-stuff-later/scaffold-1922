...
@DisplayName("MySQL Integration Test") 
@Testcontainers
public class DatabaseWithTestContainersMySQLIT extends DatabaseWithTestContainers {
    ...
    public LeaderElectorConfiguration getLeaderElectorConfiguration(String schemaName, String tableName) {
        return LeaderElectorConfiguration.builder()
                .withDatabaseEngine(DatabaseEngine.MYSQL)
