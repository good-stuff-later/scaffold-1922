...
@DisplayName("Microsoft SQL Server Integration Test") 
@Testcontainers
public class DatabaseWithTestContainersMSSQLIT extends DatabaseWithTestContainers {
    
    @BeforeAll
    public static void setUpBeforeAll() {
        System.out.println("----------------------------------------------");
        System.out.println("  PMicrosoft SQL Server                       ");
        System.out.println("----------------------------------------------");
    }

    // will be shared between test methods
    @Container
    private static final   MSSQLServerContainer MSSQL_CONTAINER = new MSSQLServerContainer("mcr.microsoft.com/mssql/server:2017-CU12")
        .acceptLicense();
    ...
    public LeaderElectorConfiguration getLeaderElectorConfiguration(String schemaName, String tableName) {
        return LeaderElectorConfiguration.builder()
                .withDatabaseEngine(DatabaseEngine.MSSQL)
