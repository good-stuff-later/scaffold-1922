...
public class EventTypesConverter implements Converter<String, EnumSet<LeaderElectorListener.EventType>> {

    private static final String ALL = "#ALL#";
    @Override
    public EnumSet<LeaderElectorListener.EventType> convert(String source) {
